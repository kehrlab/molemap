...
std::tuple<std::tuple<std::string, *String<uint32_t, External<ExternalConfigLarge<>> >, *String<uint32_t> >,...
           std::tuple<std::string, *String<uint_fast8_t, External<ExternalConfigLarge<>> >, *String<uint_fast8_t> >,...
           std::tuple<std::string, *String<uint32_t, External<> >, *String<uint32_t> >,...
           std::tuple<std::string, *String<int32_t, External<> >, *String<int32_t> > > Index_builder;
